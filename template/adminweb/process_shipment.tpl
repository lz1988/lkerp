...
function addrow(){
	...
	tdstr+='<td><!--{echo $sold_accountstr}--></td>';//销售帐号
	tdstr+='<td><!--{echo $sold_payrecstr}--></td>';//收款帐号
	tdstr+='<td><!--{echo $b2b_customers}--></td>';//b2b客户	
	
    tdstr+='<td><!--{echo $e_shippingstr}--></td>';//发货方式	
...
<div id="notice"></div>
<div id="msg"></div>
<div style="margin-top:10px; margin-bottom:5px;"><font size='1'>* 发货仓库：<!--{echo $whouse}--> &nbsp; &nbsp;* 币种：<!--{echo $coin_code}--></font></div>
<!--填写资料部分-->
...
<td width="60"><span id="row_1" class="big">1</span><span title=删除 class=point onclick=delrow('1')><img src="./staticment/images/deletebody.gif" border="0"></td>
        ...
        <td><!--{echo $sold_accountstr}--></td>
        <td><!--{echo $sold_payrecstr}--></td>
        <td><!--{echo $b2b_customers}--></td><!--b2b客户-->
            
        <td><!--{echo $e_shippingstr}--></td><!--发货方式-->
