				...
				<ul>							
					...
					<li>
						...
						<div style="display: inline;"><nobr>							
							...
							<span class="textboxcheckbox textboxdepart" ><!--{echo $val["groupname"]}--></span></nobr>
						</div>
						<ul>
							<!--{foreach ($val['user'] as $user)}-->
							<li title="<!--{echo $user["email"]}-->">
								<div class="textboxcheckbox textboxuser"><nobr>
									<input type="checkbox" name="<!--{echo $user["eng_name"].'_'.$user["chi_name"]}-->" class="checkbox" value='<!--{echo $user["email"]}-->' />
									<!--{echo $user["eng_name"].'_'.$user["chi_name"]}--></nobr>
								</div>
							</li>
							<!--{/foreach}-->									
						</ul>
