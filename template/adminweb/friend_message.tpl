...
<body>
	...
	<div style="padding: 10px; text-align:left;">	
		<div style="float:right;"><!--{echo $page_html}--></div>
		<div><h4>留言（<!--{echo $count}-->）</h4></div>
	</div>
<!--{if ($datalist)}-->
	...
	<div class="message_main">
		<div class="name">
			<p>
				<img src="<!--{echo empty($val['picurl'])?'./data/users/face_default.png':$val['picurl'];}-->" width="100" height="100" />
			</p>
			<p>
				<!--{echo $val['fm_friendname']}-->
			</p>
		</div>
		<div class="content wall_leave_message_content" a="<!--{echo $val['id']}-->">
			<!--{if ($reply)}-->
			<div class="toolbar">
			...
			<!--{/if}-->
			<p>
				<span><!--{echo $val['fm_ctime']}--> 留言</span>
			</p>			
			...
			<div class="message_content_in">
				<ul>
					...
					<li>
						<p>
							<b><!--{echo $child['fm_friendname']}--></b>
							<!--{echo $child['fm_content']}-->
						</p>
						<p class="time">
							<span><!--{echo $child['fm_ctime']}--></span>
						</p>
					</li>
					<!--{/foreach}-->	
					<!--{if ($reply || $val['reply'])}-->				
