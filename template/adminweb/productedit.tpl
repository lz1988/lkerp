...
<input type="hidden" name="pid" value="<!--{echo $product['pid']}-->" />
<input type="hidden" name="isimage" value="<!--{echo $isimage}-->" />
<input type="hidden" name="iscost" value="<!--{echo $iscost}-->" />
<table  cellpadding="3" cellspacing="0"  width="1200px" id="bigform" >
    <tr>
        ...
        <td><input type="text" id="sku" name="sku" style="width:120px" value="<!--{echo $product['sku']}-->"/></td>
        <td><div id="skuTip" style="width:250px"></div></td>
    </tr>
    <tr>
        <td align="right"><font color="red">*</font>产品名称</td>
        <td><textarea type="text" id="product_name" name="product_name" style="width:100%; height:40px"/><!--{echo $product['product_name']}--></textarea></td>
    ...
    <tr>
        ...
        <td><input type="text" id="brand_name" name="brand_name" style="width:120px" value="<!--{echo $product['brand_name']}-->"/></td>
        <td><div id="brand_nameTip" style="width:250px"></div></td>
    </tr>
    <tr>
        <td align="right">型号</td>
        <td><input type="text" id="model_number" name="model_number" style="width:120px" value="<!--{echo $product['model_number']}-->"/></td>
        <td><div id="model_numberTip" style="width:250px"></div></td>
    </tr>
    <tr>
        <td align="right">制造商的零件编号</td>
        <td><input type="text" id="manufacturer_part_number" name="manufacturer_part_number" style="width:120px" value="<!--{echo     $product['manufacturer_part_number']}-->"/></td>
        <td><div id="manufacturer_part_numberTip" style="width:250px"></div></td>
    </tr>
    <tr>
        <td align="right"><font color="red">*</font>MOQ</td>
        <td><input type="text" id="upc_or_ean" name="upc_or_ean" style="width:120px" value="<!--{echo $product['upc_or_ean']}-->"/><span class="tips">&nbsp;/pcs</span></td>
    ...
    <tr>
        ...
        <td>
            <select name="conditionerp">
                <!--{echo ($product['conditionerp']=='normal')?' selected':''}-->>正常<!--{echo ($product['conditionerp']=='normal')?' selected':''}-->>正常<!--{echo ($product['conditionerp']=='normal')?' selected':''}-->>正常<!--{echo ($product['conditionerp']=='normal')?' selected':''}-->>正常<!--{echo ($product['conditionerp']=='normal')?' selected':''}-->>正常<!--{echo ($product['conditionerp']=='normal')?' selected':''}-->>正常<option value='normal' <!--{echo ($product['conditionerp']=='normal')?' selected':''}-->>正常</option>
                <!--{echo ($product['conditionerp']=='emptying')?' selected':''}-->>清库<!--{echo ($product['conditionerp']=='emptying')?' selected':''}-->>清库<!--{echo ($product['conditionerp']=='emptying')?' selected':''}-->>清库<!--{echo ($product['conditionerp']=='emptying')?' selected':''}-->>清库<!--{echo ($product['conditionerp']=='emptying')?' selected':''}-->>清库<!--{echo ($product['conditionerp']=='emptying')?' selected':''}-->>清库<option value='emptying' <!--{echo ($product['conditionerp']=='emptying')?' selected':''}-->>清库</option>
                <!--{echo ($product['conditionerp']=='quality')?' selected':''}-->>停止销售-质量问题<!--{echo ($product['conditionerp']=='quality')?' selected':''}-->>停止销售-质量问题<!--{echo ($product['conditionerp']=='quality')?' selected':''}-->>停止销售-质量问题<!--{echo ($product['conditionerp']=='quality')?' selected':''}-->>停止销售-质量问题<!--{echo ($product['conditionerp']=='quality')?' selected':''}-->>停止销售-质量问题<!--{echo ($product['conditionerp']=='quality')?' selected':''}-->>停止销售-质量问题<option value='quality' <!--{echo ($product['conditionerp']=='quality')?' selected':''}-->>停止销售-质量问题</option>
                <!--{echo ($product['conditionerp']=='profit')?' selected':''}-->>停止销售-低利润<!--{echo ($product['conditionerp']=='profit')?' selected':''}-->>停止销售-低利润<!--{echo ($product['conditionerp']=='profit')?' selected':''}-->>停止销售-低利润<!--{echo ($product['conditionerp']=='profit')?' selected':''}-->>停止销售-低利润<!--{echo ($product['conditionerp']=='profit')?' selected':''}-->>停止销售-低利润<!--{echo ($product['conditionerp']=='profit')?' selected':''}-->>停止销售-低利润<option value='profit' <!--{echo ($product['conditionerp']=='profit')?' selected':''}-->>停止销售-低利润</option>
                <!--{echo ($product['conditionerp']=='tort')?' selected':''}-->>停止销售-侵权<!--{echo ($product['conditionerp']=='tort')?' selected':''}-->>停止销售-侵权<!--{echo ($product['conditionerp']=='tort')?' selected':''}-->>停止销售-侵权<!--{echo ($product['conditionerp']=='tort')?' selected':''}-->>停止销售-侵权<!--{echo ($product['conditionerp']=='tort')?' selected':''}-->>停止销售-侵权<!--{echo ($product['conditionerp']=='tort')?' selected':''}-->>停止销售-侵权<option value='tort' <!--{echo ($product['conditionerp']=='tort')?' selected':''}-->>停止销售-侵权</option>
            </select>        </td>
        <td><div id="conditionTip" style="width:250px"></div></td>
    </tr>
    <tr>
        <td align="right">原始成本</td>
        <td><!--{echo $cost1input}--></td>
    ...
    <tr>
        ...
        <td><!--{echo $costpre}--><span class="tips">&nbsp;</span></td>
    ...
    <tr>
        ...
        <td><input type="text" id="cost3" name="cost3" style="width:120px"  value="<?=$cost3;?>"/><span class="tips">&nbsp;
         <input  class="radio" type="radio" name="coin_code" title="美元" value="USD" onclick="changeprice('USD');" <!--{echo $coin_code=='USD'?'checked':''}--> >USD  <input class="radio" type="radio" name="coin_code" title="人民币" value="CNY" onclick="changeprice('CNY');" <!--{echo $coin_code=='CNY'?'checked':''}--> >CNY <input class="radio" type="radio"  name="coin_code" value="GBP" title="英磅" onclick="changeprice('GBP');" <!--{echo $coin_code=='GBP'?'checked':''}--> >GBP</label>&nbsp; &nbsp;(最多两位小数，超过两位系统自动四舍五入)</span><input type="hidden" id="coin_code" value=<!--{echo $coin_code}--> > </td>
        <td></td>
    </tr>
    <tr>
        ...
        <td colspan="3" >  
            <table cellspacing='0' cellpadding='0' border='0' width="100%" heigh="100%" style="font-size:12px" >
                <tr>
                    ...
                    <td width="400px"><div style=" position: relative; width:500px; height: 170px;overflow-y:auto; padding: 0; margin: 0; "><!--{echo $listing_taobao}--></div></td>
                    ...
                    <td width="400px"><div style=" position: relative; width:500px; height: 170px;overflow-y:auto; padding: 0; margin: 0; "><!--{echo $listing_jd}--></div></td>
                </tr>
                <tr>
                    ...
                    <td width="400px"><div style=" position: relative; width:500px; height: 170px;overflow-y:auto; padding: 0; margin: 0; "><!--{echo $listing_yihaodian}--></div></td>
                    ...
                    <td width="400px"><div style=" position: relative; width:500px; height: 170px;overflow-y:auto; padding: 0; margin: 0; "><!--{echo $listing_amazon}--></div></td>
                </tr>
                <tr>
                    ...
                    <td width="400px"><div style=" position: relative; width:500px; height: 170px;overflow-y:auto; padding: 0; margin: 0; "><!--{echo $listing_cn}--></div></td>
                    ...
                    <td width="400px"><div style=" position: relative; width:500px; height: 170px;overflow-y:auto; padding: 0; margin: 0; "><!--{echo $listing_us}--></div></td>
                </tr>
            </table>
             <!-- 存储图片临时地址-->
          <!--<div id="aryimg" style="width:500px;"><ul style="list-style-type:none;"></ul></div>-->        </td> 
    ...
    <tr>
        ...
        <td>
            <table border='0' id="t_k" cellspacing="5"><!--{echo $key_product_features}--></table>
  ...
  <td>
    ...
    <tr>
        ...
        <td>
            <table border='0' id="t_p" cellspacing="5"><!--{echo $platinum_keywords}--></table>
    ...
    <tr>
        ...
        <td>
            <table border='0' id="t_r" cellspacing="5"><!--{echo $related_keywords}--></table>
    ...
    <tr>
        ...
        <td><input type="text" id="target_customers" name="target_customers" style="width:120px" value="<!--{echo $product['target_customers']}-->"/></td>
    ...
    <td align="right"><span id="ch_inch" class="chs">[inch]</span>产品尺寸(长×宽×高)</td>
       <td><input type="text" onkeyup="getkey('product_size')" name="product_size" value="<!--{echo $product['product_size']}-->"/><span class="tips">&nbsp;/cm&nbsp;</span></td>
       <td>&nbsp;</td>
    </tr>
    <tr>
     <td align="right"><span id="ch_lbs" class="chs">[lbs]</span> <span id="ch_oz" class="chs">[oz]</span>产品净重</td>
       <td><input type="text" name="product_weight" value="<!--{echo $product['product_weight']}-->"/><span class="tips">&nbsp;/kg&nbsp;</span></td>
       <td>&nbsp;</td>
     ...
     <td align="right"><span id="ch_inch" class="chs">[inch]</span> <font color="red">*</font>单个产品包装尺寸(长&times;宽&times;高)</td>
       <td><input type="text" onkeyup="getkey('product_dimensions')"  name="product_dimensions" value="<!--{echo $product['product_dimensions']}-->"/>
    ...
    <tr>
        ...
        <td><input type="text" name="shipping_weight" value="<!--{echo $product['shipping_weight']}-->"/>
          <span class="tips">&nbsp;/kg&nbsp;(单个产品毛重(产品+包装重量))</span></td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td align="right">长&times;宽&times;高(箱)</td>
        <td><input type="text" onkeyup="getkey('box_product_dimensions')" name="box_product_dimensions" value="<!--{echo $product['box_product_dimensions']}-->"/><span class="tips">&nbsp;/cm&nbsp;(材积重/箱)</span></td>
        <td>&nbsp;</td>
    </tr>
    
     <tr>
        <td align="right">发货重量(箱)</td>
        <td><input type="text" name="box_shipping_weight" value="<!--{echo $product['box_shipping_weight']}-->"/><span class="tips">&nbsp;/kg&nbsp;(产品重/箱)</span></td>
        <td>&nbsp;</td>
    </tr>
    ...
    <tr>
        ...
        <td><input type="text" name="style_name" value="<!--{echo $product['style_name']}-->"/></td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td align="right"><font color="red">*</font>颜色</td>
        <td><input type="text" name="color" value="<!--{echo $product['color']}-->"/></td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td align="right">大小</td>
        <td><input type="text" name="size" value="<!--{echo $product['size']}-->"/></td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        ...
        <td>
            ...
            <!--{echo ($product['box_type']=='白盒中性包装')?' selected':''}--> >白盒中性包装<!--{echo ($product['box_type']=='白盒中性包装')?' selected':''}--> >白盒中性包装<!--{echo ($product['box_type']=='白盒中性包装')?' selected':''}--> >白盒中性包装<!--{echo ($product['box_type']=='白盒中性包装')?' selected':''}--> >白盒中性包装<!--{echo ($product['box_type']=='白盒中性包装')?' selected':''}--> >白盒中性包装<!--{echo ($product['box_type']=='白盒中性包装')?' selected':''}--> >白盒中性包装<option value="白盒中性包装" <!--{echo ($product['box_type']=='白盒中性包装')?' selected':''}--> >白盒中性包装</option>
            <!--{echo ($product['box_type']=='彩盒中性包装')?' selected':''}-->>彩盒中性包装<!--{echo ($product['box_type']=='彩盒中性包装')?' selected':''}-->>彩盒中性包装<!--{echo ($product['box_type']=='彩盒中性包装')?' selected':''}-->>彩盒中性包装<!--{echo ($product['box_type']=='彩盒中性包装')?' selected':''}-->>彩盒中性包装<!--{echo ($product['box_type']=='彩盒中性包装')?' selected':''}-->>彩盒中性包装<!--{echo ($product['box_type']=='彩盒中性包装')?' selected':''}-->>彩盒中性包装<option value="彩盒中性包装" <!--{echo ($product['box_type']=='彩盒中性包装')?' selected':''}-->>彩盒中性包装</option>
            <!--{echo ($product['box_type']=='品牌包装')?' selected':''}-->>品牌包装<!--{echo ($product['box_type']=='品牌包装')?' selected':''}-->>品牌包装<!--{echo ($product['box_type']=='品牌包装')?' selected':''}-->>品牌包装<!--{echo ($product['box_type']=='品牌包装')?' selected':''}-->>品牌包装<!--{echo ($product['box_type']=='品牌包装')?' selected':''}-->>品牌包装<!--{echo ($product['box_type']=='品牌包装')?' selected':''}-->>品牌包装<option value="品牌包装" <!--{echo ($product['box_type']=='品牌包装')?' selected':''}-->>品牌包装</option>
            <!--{echo ($product['box_type']=='其它包装')?' selected':''}-->>其它包装<!--{echo ($product['box_type']=='其它包装')?' selected':''}-->>其它包装<!--{echo ($product['box_type']=='其它包装')?' selected':''}-->>其它包装<!--{echo ($product['box_type']=='其它包装')?' selected':''}-->>其它包装<!--{echo ($product['box_type']=='其它包装')?' selected':''}-->>其它包装<!--{echo ($product['box_type']=='其它包装')?' selected':''}-->>其它包装<option value="其它包装" <!--{echo ($product['box_type']=='其它包装')?' selected':''}-->>其它包装</option>
            </select>        </td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td align="right">一箱个数</td>
        <td><input type="text" name="unit_box" value="<!--{echo $product['unit_box']}-->"/><span class="tips">&nbsp;unit/box</td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td align="right">是否有认证</td>
        <td><input type="text" name="attestation" value="<!--{echo $product['attestation']}-->" style="width:300px"/><span class="tips">&nbsp;</td>
        <td>&nbsp;</td>
    </tr>
</table>
<!--{if($isshow){}-->
