...
class pagerInit {
	...
	.InitPHP_pages {font:12px/1.6em Helvetica, Arial, sans-serif;text-align:center; font-family:Verdana;margin-bottom:5px;  }
	.InitPHP_pages a, .pages{ margin:0 1px; padding:2px 6px; border:1px solid #E4E4E4; text-decoration:none!important; }
	...
	.InitPHP_pages .back { padding:4px 6px 2px 6px!important; padding:4px 6px 2 6px;  font-family:simsun; }
	.InitPHP_pages .next { padding:4px 6px 2px 6px!important; padding:4px 6px 2 6px; font-family:simsun; }
	.InitPHP_pages .first { padding:4px 6px 2px 4px!important; padding:4px 6px 2 4px;  font-family:simsun; }
	.InitPHP_pages .last { padding:4px 4px 2px 6px!important; padding:4px 4px 2 6px; font-family:simsun; }
	</style>';
