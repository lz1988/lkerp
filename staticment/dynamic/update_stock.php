...
if (in_array($file_ext, $ext_arr) === false) {
	...
	*/
	...
	//创建文件夹
	$ymd = date("Ymd");
	$save_path .= "data/stockorder/".$ymd . "/";
	$save_url .= "data/stockorder/".$ymd . "/";
	$dl_save_url =  "data/stockorder/".$ymd . "/"; //此路径用于删除
	...
	$backstr = '';
	$backstr.= "<div style='width:116px;height:125px;float:left;padding:3px;'>";
	$backstr.= "	<div style='float:left'><img src=".$file_url." alt=$img_alt style='border:solid 1px #828482; width:115px;height:115px;'></div>";
	$backstr.= "<div style='float:left;'>";
	$backstr.="<input type='hidden' name='img_url[]' value=".$file_url."></div></div>&nbsp;";
