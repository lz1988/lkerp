<?php  if (!defined("IS_INITPHP")) exit("Access Denied!");  /* INITPHP Version 1.0 ,Create on 2014-01-21 11:57:12, compiled from template/admintag/tag_pdesc.tpl */ ?>
<style type="text/css">
.normal
{
...
<div>
    ...
    <div id="div1" style ="display :none" class ="divContent">
        <textarea id="product_desc2" name="product_desc2"><?php echo stripslashes($product['product_desc2']);  ?></textarea>
    </div>
    <div id="div2" style ="display :block" class ="divContent">
        <textarea id="product_desc" name="product_desc" style="width:650px;height:400px;visibility:hidden;"><?php echo stripslashes($product['product_desc']);  ?></textarea>                    
    </div>
    <div id="div3" style ="display :none" class ="divContent">
        <textarea id="eng_product_desc3" name="eng_product_desc3"><?php echo stripslashes($product['product_desc3']);  ?></textarea>
    </div>
</div>