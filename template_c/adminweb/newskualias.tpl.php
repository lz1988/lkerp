<?php  if (!defined("IS_INITPHP")) exit("Access Denied!");  /* INITPHP Version 1.0 ,Create on 2013-09-03 15:00:07, compiled from template/adminweb/newskualias.tpl */ ?>
<?php echo $jslink ?>
...
<form id="skuform" action="<?php echo $jumpurl ?>" method="post">
	<div style="font-size:12px; margin-bottom:10px; margin-top:10px; padding-left:3px;">别名使用组：<?php echo $sold_wayselect ?></div>
