<?php  if (!defined("IS_INITPHP")) exit("Access Denied!");  /* INITPHP Version 1.0 ,Create on 2014-01-13 10:47:09, compiled from template/adminweb/upstock_image.tpl */ ?>
...
><tr>
	<td><div style="margin-left:22px; margin-bottom:15px; font-size:12px"><?php echo $showstr ?></div>
