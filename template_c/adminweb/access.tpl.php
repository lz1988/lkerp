<?php  if (!defined("IS_INITPHP")) exit("Access Denied!");  /* INITPHP Version 1.0 ,Create on 2014-01-21 15:08:15, compiled from template/adminweb/access.tpl */ ?>
<style type="text/css">
        ...
        <legend> 对象 </legend>
            <div style="height:400px; width:200px; overflow-y:auto;" class="group_id">
                ...
                <?php foreach($group_list as $g){ ?>
                    <tr>
                     <td>
                        <label  class="gr_<?php echo $g['id'] ?>">
              				<input type="radio" name="thisid" value ="<?php echo $g['id'] ?>" data="group" onclick=go(<?php echo $g['id'] ?>) ><?php echo $g['groupname'] ?>
                        </label>
                     </td>
                    </tr>
                <?php } ?>
