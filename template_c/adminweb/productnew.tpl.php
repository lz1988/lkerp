<?php  if (!defined("IS_INITPHP")) exit("Access Denied!");  /* INITPHP Version 1.0 ,Create on 2014-01-13 10:43:05, compiled from template/adminweb/productnew.tpl */ ?>
...
<span style="font-size:12px;">当前选择的类别是：<?php echo $showcat ?></span>
...
<table  border="1" cellpadding="3" cellspacing="0"  width="1200px" id="bigform">
    ...
    <tr>
        ...
        <td>
        <!--描述区-->      
        <?php include('template_c/admintag/tag_pdesc.tpl.php'); ?>
        </td>
        <td><div id="product_descTip" style="width:250px"></div></td>            
    </tr>
    <tr>
...
<input type="hidden" name="trh" value="<?php echo $trh ?>" />
